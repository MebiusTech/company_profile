      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="body-md text-gray-700 max-w-sm">
            Merging raw, unpolished idea and creativity with modern, state-of-the-art software craftsmanship.
          </p>
          <div className="flex gap-2">
            <span className="pixel-sticker bg-primary-container text-black">Mebius Tech</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link href="/products" className="font-code text-sm text-gray-800 hover:text-secondary hover:underline transition-all">
              Products
            </Link>
            <Link href="/contact" className="font-code text-sm text-gray-800 hover:text-secondary hover:underline transition-all">
              Contact
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-4 mt-2 font-code text-sm font-bold">
            <a href="https://github.com/MebiusTech/" target="_blank" rel="noopener noreferrer" className="hover:underline text-black">
              Github
            </a>
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:underline text-black">
              Tiktok
            </a>
